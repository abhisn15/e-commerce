  ...
  return (
    <Headroom>
      <div className="header">
        <div className="heading w-full h-1 bg-cyan-400"></div>
        <div className="left flex gap-12 px-6 py-4 pb-0">
          ...
          <Link to="/" className="flex fle">
            <div className="left-icon-contact flex justify-between">
              <span className="whitespace-nowrap content-end">Contact Us</span>
            </div>
          </Link>
        </div>
        <div className="middle px-10 pt-[8px] pb-0">
          <Link to="/">
            <span className="judul text-4xl font-serif">C</span>
            <span className="judul text-2xl font-serif">LOUFEE</span>
          </Link>
        </div>
        <div className="right flex gap-10 justify-end px-10 py-4 pb-0">
