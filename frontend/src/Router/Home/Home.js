    ...
    <div className="section">
        ...
        <div className="one min-[1400px]:w-[1460px] min-[1400px]:h-[690px] lg:h-[640px] md:w-[1350px] h-[653px] 2xl:hidden">
          <div className="relative flex flex-col items-center top-60 w-1/3">
            ...
            <p className="mx-8 mt-2 text-center text-md">
              Our House ambassadors make Cloufee their own in our latest
              campaign.
            </p>
      ...
      <div className="content4">
        <div className="flex justify-center items-center">
          <img src={cloufee} className="cloufee md:w-[800px]" alt="cloufee" />
          <div className="open-landmark flex flex-col">
            ...
            <div className="font-serif pt-[10px]">
              <span className="">
                ...
                new Cloufee. for a new era at 727 Fifth Avenue, New York.
              </span>
            </div>
            <div className="learn-more flex pt-[10px]">
              {Learnmore.map((data) => (
                <Link key={data.id} to="/" className="">
