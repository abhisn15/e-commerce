...
const Home = () => {
  ...
  useEffect(() => {
    ...
    dsc
      .to(".open-landmark", { x: 80, duration: 4 })
    ...
    <div className="section">
        ...
        <Slider className="md:ml-16 md:mr-10 2xl:ml-24" {...carouselProperties}>
          {productData.map((items) => (
            <div key={items.id} className="">
              <Link to="/">
                <img
                  className="w-auto md:h-[370px] 2xl:h-[432px] object-contain mb-10"
                  src={items.imageurl}
                ></img>
              </Link>
        ...
        <div className="card-popular relative flex justify-center z-0 md:gap-24">
          {productPopular.map((item) => (
            <div className="flex flex-col items-center mb-20" key={item.id}>
              ...
              <Link to={item.shop} className="shop-now flex mt-2">
      ...
      <div className="content4">
        <div className="flex items-center">
          <video
            className="video md:w-[940px]"
            src="https://media.tiffany.com/is/content/tiffanydm/TiffanyLandmark_6sCutdownFloral_1920x1080"
            type="video/mp4"
            autoPlay
            muted
            loop
          ...
          <div className="open-landmark flex flex-col">
            ...
            <div className="font-serif pt-[10px]">
              <span className="">
                A legacy of brilliance continues with The Landmark. Discover a
                new Tiffany & Co. for a new era at 727 Fifth Avenue, New York.
              </span>
            </div>
